...
"""
>>> mountainCarContinuousEnv = gym.make('MountainCarContinuous-v0')
>>> print(mountainCarContinuousEnv.action_space)
Box(1,)
>>> print(mountainCarContinuousEnv.observation_space)
Box(2,)

>>> print(mountainCarContinuousEnv.observation_space.high)
[0.6  0.07]
>>> print(mountainCarContinuousEnv.observation_space.low)
[-1.2  -0.07]
>>> print(mountainCarContinuousEnv.action_space.low)
[-1.]
>>> print(mountainCarContinuousEnv.action_space.high)
[1.]
...
class NeuralNet(torch.nn.Module):
    ...
    def forward(self, inputs):
        ...
        return torch.tanh(dataState) # Squashes the value in ]-1, 1[ . See action_space.low, action_space.high
...
def main():
    print ("MountainCarContinuous-v0/NNController.py main()")
